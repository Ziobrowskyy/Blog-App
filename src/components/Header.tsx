            ...
            <header>
                <Navbar>
                    <NavbarBrand>
                        ...
                        <svg id='logoipsum' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 177.778 100'>
                            ...
                            <path
                                ...
                                fill='#1dace3'/>
                            <path
                                d='M46.752,39.918l-9.764-1.507L25,41.666l4.785,9.361L40.99,58.759a2.888,2.888,0,0,0,.806.383l4.256-8.323Z'
                                fill='#001a49'/>
                            <path
                    ...
                    <Nav className={"mr-auto"}>
                        ...
                        <NavLink><Link className={"nav-link"} to={"/posts"}>Posts</Link></NavLink>
                        <NavLink><Link className={"nav-link"} to={"/admin-panel"}>Admin panel</Link></NavLink>
                    </Nav>
                </Navbar>
            </header>
        )
